  ...
  return (
    <div className="flex flex-col min-h-screen w-full bg-[#F3EBDD] text-[#5C5147] font-sans overflow-auto selection:bg-[#8C5A3C] selection:text-[#FFFDF8]">
      ...
      <div className="sticky top-0 z-10 w-full bg-[#FBF7EF]/95 backdrop-blur-xl border-b border-[#D8CDBD] pt-6 pb-4 md:pt-8 transition-all duration-200 shadow-sm">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between px-5 md:px-12 max-w-7xl mx-auto gap-4">
          ...
          <Button
            asChild
            className="bg-[#8C5A3C] hover:bg-[#A06A47] text-[#FFFDF8] rounded-2xl px-6 py-6 shadow-md transition-all duration-200 ease-out font-medium shrink-0"
          >
            <Link href="/interview">
      ...
      <main className="flex-1 w-full max-w-7xl mx-auto px-5 md:px-12 py-8 md:py-10">
        ...
        <section className="mb-10 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
          <div className="rounded-2xl border border-[#D8CDBD] bg-[#FFFDF8] shadow-sm p-6 overflow-hidden transition-all hover:border-[#8C5A3C]/30">
            ...
            <div className="grid gap-4">
              {sessions
                ...
                .map((item) => (
                  <article
                    key={item._id}
                    className="group rounded-2xl border border-[#D8CDBD] bg-[#FFFDF8] p-5 md:p-6 shadow-sm transition-all duration-200 hover:border-[#8C5A3C]/50 hover:bg-[#FBF7EF]"
                  >
                    <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                      <div className="min-w-0 flex-1">
                        ...
                        <h3 className="truncate text-lg md:text-xl font-medium text-[#2B2118] group-hover:text-[#8C5A3C] transition-colors">
                          Session {item._id.slice(-6).toUpperCase()}
                        </h3>

                        <div className="mt-2.5 flex flex-wrap gap-x-4 gap-y-2 text-xs md:text-sm text-[#8D8175]">
                      ...
                      <div className="flex flex-col gap-3 sm:flex-row sm:items-center mt-2 lg:mt-0 shrink-0">
                        <div className="rounded-xl border border-[#D8CDBD] bg-[#FBF7EF] px-5 py-2.5 text-center min-w-22.5">
                          <div className="text-[10px] uppercase tracking-widest text-[#8D8175] mb-0.5 font-medium">
                            Score
                          </div>
                          <div className="text-lg md:text-xl font-medium text-[#8C5A3C]">
                        ...
                        <Button
                          asChild
                          className="bg-[#8C5A3C] hover:bg-[#A06A47] text-[#FFFDF8] rounded-xl px-6 py-6 sm:py-0 h-auto sm:h-15.5 shadow-sm transition-all font-medium"
                        >
                          {item.status.toLowerCase() === 'completed' ? (
